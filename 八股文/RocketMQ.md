...
- 顺序消息：**“消息的生产、存储、投递和消费都严格按照消息的顺序”**，尤其是业务上的顺序，比如订单的下单-支付-发货-完成，这种流程很依赖消息顺序。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MjI1NDEwMjIsMzUwOTU1NjgsODU0MD
kwNjY4LC02NDg2OTQyMTQsMTE5ODYwNTk4OCwtMjA4ODc0NjYx
