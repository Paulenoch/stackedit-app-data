...
这是消息队列最经典的应用之一：将核心流程与非核心流程解耦。

-   **问题**: 抽奖是系统的核心链路，必须快速响应。而“发奖”这个动作可能很复杂，比如需要调用第三方接口（充值话费）、更新用户积分（可能涉及锁和事务）、或者进行复杂的账户操作。如果将这些耗时且可能失败的操作放在主抽奖流程中同步执行，会严重拖慢抽奖接口的响应速度，甚至因为发奖失败导致整个抽奖失败。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNzk1MTE5OTQsMjAyNTY4OTQxNiwtNz
k1NTQwMDAsLTM0Nzg1MDgzLDE5NjY3MDQ0MjgsNTA1MzA5ODQs
LTEyOTU1MjUxNDcsMTU2OTExMzc2MV19
-->